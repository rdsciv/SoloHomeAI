(function () {
      const THEME_KEY = "solohome-system-map-theme";
...
Act     → call_service | wait Ask | deny`
      ...
      const insp = {
        ...
        badges: document.getElementById("insp-badges"),
        meta: document.getElementById("insp-meta"),
        code: document.getElementById("insp-code")
      };
      ...
      function selectNode(id) {
        ...
        document.querySelectorAll("#edges .edge").forEach((e) => e.classList.remove("active"));
      ...
      function selectDevice(d) {
        ...
        document.querySelectorAll(".topo-zone").forEach((el) => {
      ...
      function selectZone(z) {
        ...
        document.querySelectorAll(".device-node").forEach((el) => el.setAttribute("data-selected", "false"));
